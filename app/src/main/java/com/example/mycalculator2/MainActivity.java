...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnTouchListener
{
    ...
    //Khoi tao chuc nang  click vao nut
    ...
    //Khoi tao chuc nang cham vao nut
    ...
    public void onClick(View view)
    {
        switch (view.getId())
        {
            case R.id.button_zero:
                //Them so 0 vao text view
                if (addNumber("0")) equalClicked = true;
                break;
            case R.id.button_one:
                //them so 1 vao text view
                if (addNumber("1")) equalClicked = true;
                break;
            case R.id.button_two:
                if (addNumber("2")) equalClicked = true;
                break;
            case R.id.button_three:
                if (addNumber("3")) equalClicked = true;
                break;
            case R.id.button_four:
                if (addNumber("4")) equalClicked = true;
                break;
            case R.id.button_five:
                if (addNumber("5")) equalClicked = true;
                break;
            case R.id.button_six:
                if (addNumber("6")) equalClicked = true;
                break;
            case R.id.button_seven:
                if (addNumber("7")) equalClicked = true;
                break;
            case R.id.button_eight:
                if (addNumber("8")) equalClicked = true;
                break;
            case R.id.button_nine:
                if (addNumber("9")) equalClicked = true;
                break;
            case R.id.button_addition:
                //Them dau cong vao text view
                if (addOperand("+")) equalClicked = true;
                break;
            case R.id.button_subtraction:
                //Them  dau tru vao text vieww
                if (addOperand("-")) equalClicked = true;
                break;
            case R.id.button_multiplication:
                //Them dau nhan vao text view
                if (addOperand("x")) equalClicked = true;
                break;
            case R.id.button_division:
                //Them dau chia vao text view
                if (addOperand("\u00F7")) equalClicked = true;
                break;
            case R.id.button_percent:
                //Them dau % vao text view
                if (addOperand("%")) equalClicked = true;
                break;
            case R.id.button_dot:
                //Them dau cham
                if (addDot()) equalClicked = true;
                break;
            case R.id.button_parentheses:
                //Them dau dong mo ngoac
                if (addParenthesis()) equalClicked = true;
                break;
            ...
            case R.id.button_equal:
                //Xuat ket qua khi man hinh co du lieu tren text view
    ...
    //Khi bam vao nut se hien thi mau xanh lo
    @Override
    ...
    //Them dau "(" neu khoi dau phep toan. Them dau ")" neu truoc do da co dau "(" de ket thuc ()
    ...
    private boolean addOperand(String operand)
    {
        ...
        {
            Toast.makeText(getApplicationContext(), "Phep toan sai dinh dang. Phai co so hang khi truoc khi bat dau phep toan", Toast.LENGTH_LONG).show();
        }
        return done;
    }
    //Them so len text view
    ...
    private void calculate(String input)
    {
        ...
        try
        {
            ...
            // Thay the cac dau phep toan thanh cac dau phep toan cho code hieu duoc la phep toan gi
        ...
        {
            Toast.makeText(getApplicationContext(), "Khong duoc phep chia cho 0", Toast.LENGTH_SHORT).show();
    ...
    //Luu lai ket qua vua nhap vao CSDl
